...
def sign_in():
    if usernameEntry.get()=='228r1a0556' or passwordEntry.get()=='sumana@123':
        messagebox.showerror('Error','Enter all fields')
    else:
        try:
            con=pymysql.connect(host='localhost',user='root',password='sumana@123',database='abc')
            cur=con.cursor()
        except:
...
background=ImageTk.PhotoImage(file='Motherteresa.jpeg')
